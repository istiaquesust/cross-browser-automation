...
public class DesktopDevice {
	...
	/* Configure remote system. As automation will run in parallel basis & values are dynamic, configuration values are got from @Parameters*/
	@BeforeTest
	@Parameters({ "browserName", "version", "platform", "resolution", "build", "name", "network", "visual", "video", "console" })
	public void setUp(String browserName, String version, String platform, String resolution, String build, String name,
			String network, String visual, String video, String console) throws Exception {
